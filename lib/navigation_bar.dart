...
import 'package:luxury_chauffeur/home_screen.dart';
      ...
      bottomNavigationBar: Theme(
        ...
        child: BottomNavigationBar(
          ...
          items: const <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(icon: Icon(Icons.list_alt), label: 'Notifications'),
            BottomNavigationBarItem(icon: Icon(Icons.notifications), label: 'Account'),
          ],
